    ...
    >
      ...
      <div className="bg-gradient-to-r from-[#287dff] to-[#417dff] text-white p-3 md:p-4">
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3 className="flex-1 min-w-0 break-words text-base md:text-lg font-bold leading-tight">
            {hospital.병원명}
          </h3>
          <span className={`flex-shrink-0 px-2 py-1 rounded-full text-xs font-bold ${status.color}`}>
            {status.text}
          </span>
        </div>
      ...
      <div className="p-3 md:p-4 space-y-3">
        ...
        <div className="bg-[#eff6ff] rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm md:text-base font-semibold text-[#242424]">응급실 가용 병상</span>
          </div>
          <div className="grid grid-cols-3 gap-2 text-center">
            <div>
              <div className="text-xs text-gray-600 mb-1">일반</div>
              <div className="text-lg md:text-xl font-bold text-[#287dff]">{hospital.응급실_일반}</div>
            </div>
            <div>
              <div className="text-xs text-gray-600 mb-1">소아</div>
              <div className="text-lg md:text-xl font-bold text-[#287dff]">{hospital.응급실_소아}</div>
            </div>
            <div>
              <div className="text-xs text-gray-600 mb-1">야간</div>
              <div className="text-lg md:text-xl font-bold text-[#287dff]">{hospital.응급실_야간}</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="bg-[#f9fafb] rounded-lg p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-[#242424]">중환자실</span>
            </div>
          ...
          <div className="bg-[#f9fafb] rounded-lg p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-[#242424]">의료장비</span>
            </div>
            <div className="space-y-1 text-xs">
              <div className="flex justify-between">
        ...
        <div className="flex items-center justify-between pt-2 border-t">
          ...
          <button
            onClick={() => router.push(`/hospital/${hospital.기관ID}`)}
            className="flex items-center gap-1 px-3 py-1.5 text-sm text-[#287dff] hover:bg-blue-50 rounded-lg transition-colors font-medium"
          >
            상세보기
